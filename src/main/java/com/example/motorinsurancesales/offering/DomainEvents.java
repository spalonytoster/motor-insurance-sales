...
sealed interface DomainEvents {
    ...
    record InitialCalculationContextChanged() implements DomainEvents {} // might not be needed. instead typical calculation event will be emitted
    record AvailabilityCalculated() implements DomainEvents {} // could be also
